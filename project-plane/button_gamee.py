...
class button_game:
    def __init__(self,x,y,content,replitbad,overallsound,screen,abilityselection,abilitydescription):
        ...
        self.x,self.y=x,y
        self.rect=pygame.Rect((self.x,self.y), (content.get_width(),content.get_height()))
        if not replitbad:
    ...
    def text(self,ability,bigbox,anumber,textbox,evolve):
            ...
            self.rect=pygame.Rect((self.x,self.y), (self.content.get_width()+10  ,self.content.get_height()))
            ...
            if pygame.display.get_init():
                self.screen.blit(self.content,(self.rect.x+5,self.rect.y))
