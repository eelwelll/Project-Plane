...
abilities=[("Propeller-Dispresion"),("Missile-Barrage"),("High-Calibre"),("Accelerated-Shot"),("Advanced-Airframe"),("The-Fat-Man"),("EMP")]
abilitydescription=["The propeller seems to be malfunctioning,^ wind is disperssing all over now!",
                    ...
                    "The Fat Man^",
                    "An intense burst of electromagnetic energy^"]
